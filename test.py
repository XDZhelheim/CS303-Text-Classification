...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--test_file', type=str, default='D:\\Codes\\PythonWorkspace\\AI_Lab\\LogisticRegression\\testdataexample')
    parser.add_argument('-m', '--model_file', type=str, default='D:\\Codes\\PythonWorkspace\\AI_Lab\\LogisticRegression\\model.pkl')
